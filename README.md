...
3. For your first time using Appium Inspector you will need to configure your Desired Capabilities. You will be able to save it for the future so this will only happen once. The names (capabilities) and values depend on what exists in your Base or BrowserBase class.  
    ...
    b. *Users that open a pre-installed app on their phone*
6. Use the dropdown at the bottom of the page to select your ongoing session. You should see details for your current device included. If nothing appears use the refresh button to the right of the drop down to get the session details from the server. 
