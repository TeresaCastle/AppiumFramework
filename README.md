...
#### Test Body
1. There are several methods for locating objects on iOS. <br> a. Xcode (Use XCUITest) <br> b. Appium Desktop Inspector <br> c. Printing the page source code with System.out.println(driver.getPageSource()); and manually locating the right code. You can look up ways to use this information to create the xpath but typically it follows this format:  //tagName[@attribute=’value’] e.g. //textView[@id='idvalue']
